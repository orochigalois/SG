...
$zip = new zipfile();
//----------------------
$filename = substr(strrchr($_GET["URL"],'/'),1).'_sentence.zip'; //下载的默认文件名
...
for ($i = 0; $i < count($rows); $i++) 
{
    ...
    $wordfile='./userdata/'.$_SESSION['user'].'/sentence/'.$word.'.mp3';
	$wordfilename=$word.'.mp3';
	$zip->add_file(file_get_contents($wordfile),  $wordfilename);
